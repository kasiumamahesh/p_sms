            ...
            <div class="login-form">
                <form method="post" action="<?php echo base_url('admin/checking');?>" id="login_form">
                    <div class="form-group">
                        ...
                        <input type="email" id="lf_email" name="email" class="form-control" placeholder="Email">
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input type="password" id="lf_password" name="password" class="form-control" placeholder="Password">
                    </div>
                    <div class="checkbox">
                        <label>
