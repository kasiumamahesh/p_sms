...
$sid=$this->db->insert_id();
	...
	public function get_all_schedules(){
		...
		schedule_tab.end_date,group_tab.group_name,message_template.template_content,schedule_id');
		$this->db->from('schedule_tab');
		$this->db->join('sms_plan_type','sms_plan_type.plan_id=schedule_tab.sms_type');
		$this->db->join('group_tab','group_tab.group_id=schedule_tab.group_id','left');
		$this->db->join('message_template','message_template.template_id=schedule_tab.template_id','left');
